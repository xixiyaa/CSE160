...
// cuon-matrix.js (c) 2012 kanda and matsuda
// cuon-matrix-cse160.js - Vector Library

// cuon-matrix-cse160.js - Enhanced with Test Compatibility
let TEST_MODE = true; // Enable for tests when running `vectorTests.html`
...
class Vector3 {
    ...
    static dot(v1, v2) {
        return v1.elements.reduce((sum, el, i) => sum + el * v2.elements[i], 0);
    }
    ...
    magnitude() {
        return Math.sqrt(this.elements.reduce((sum, el) => sum + el ** 2, 0));
    }
